      ...
      >
        <q-card class="my-card ">
          <q-card-section>
            ...
            <q-btn flat color="black" label="Omitir" @click="onClick" to="/alumno/cultural/paso1" />
          </q-card-section>
          <q-card-section>
          ...
          <q-card-section>
            ...
            <q-radio name="promedio" v-model="promedio" val="promedio-no" label="No" @click="onClick" to="/alumno/cultural/paso1" />
          </q-card-section>
          <q-btn label="Subir" type="submit" class="" color="primary" @click="onClick" to="/alumno/cultural/paso1"/>
        </q-card>
      </q-form>
  </q-page>
</template>
