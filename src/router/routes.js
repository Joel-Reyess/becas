  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        path: "deportiva",
        name: "deportiva",
        component: () => import("src/pages/alumnopages/becadeportiva/PreForm.vue"),
      },
      {
        path: "deportiva/paso1",
        name: "deportiva/paso1",
        component: () => import("src/pages/alumnopages/becadeportiva/UnoForm.vue"),
      },
      {
        path: "deportiva/paso2",
        name: "deportiva/paso2",
        component: () => import("src/pages/alumnopages/becadeportiva/AdjuntarForm.vue"),
      },
      {
        path: "deportiva/paso3",
        name: "deportiva/paso3",
        component: () => import("src/pages/alumnopages/becadeportiva/ResumenForm.vue"),
      },
      {
        path: "economica",
        name: "economica",
        component: () => import("src/pages/alumnopages/becaeconomica/PreForm.vue"),
      },
      {
        path: "economica/paso1",
        name: "economica/paso1",
        component: () => import("src/pages/alumnopages/becaeconomica/UnoForm.vue"),
      },
      {
        path: "economica/paso2",
        name: "economica/paso2",
        component: () => import("src/pages/alumnopages/becaeconomica/AdjuntarForm.vue"),
      },
      {
        path: "economica/paso3",
        name: "economica/paso3",
        component: () => import("src/pages/alumnopages/becaeconomica/ResumenForm.vue"),
      },
      {
        path: "excelencia",
        name: "excelencia",
        component: () => import("src/pages/alumnopages/becaexcelencia/PreForm.vue"),
      },
      {
        path: "excelencia/paso1",
        name: "excelencia/paso1",
        component: () => import("src/pages/alumnopages/becaexcelencia/UnoForm.vue"),
      },
      {
        path: "excelencia/paso2",
        name: "excelencia/paso2",
        component: () => import("src/pages/alumnopages/becaexcelencia/AdjuntarForm.vue"),
      },
      {
        path: "excelencia/paso3",
        name: "excelencia/paso3",
        component: () => import("src/pages/alumnopages/becaexcelencia/ResumenForm.vue"),
      },
      {
        path: "inclusion",
        name: "inclusion",
